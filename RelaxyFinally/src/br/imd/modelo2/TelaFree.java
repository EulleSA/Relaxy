...
import br.imd.modelo.PatriciaAcessoDireto.AcessoArquivoPatriciaMusica;
import br.imd.modelo3.TelaLogin;
import br.imd.modelo3.TocaMP3;
 ...
 *
 */
public class TelaFree extends JPanel {
	 ...
	 * Create the panel.
	 */
	public TelaFree(ArvoreBinaria arvore,String id) {
		...
		btnNewButton.setBounds(67, 451, 89, 23);
		...
		btnNewButton_1.setBounds(191, 451, 89, 23);
		...
		//arvoreP.pecorrimentoArvorePatriciaarvoreP, 0, "");
		...
		lblFree.setFont(new Font("Verdana", Font.BOLD, 14));
		lblFree.setBounds(524, 34, 51, 14);
		panel.add(lblFree);
		 ...
		 btnAddDiretrio.setBounds(358, 451, 100, 23);
		 ...
		 btnNewButton_2.setBounds(485, 451, 89, 23);
		 ...
		 button.setBounds(0, 129, 51, 23);
		 panel.add(button);
		 
		 JLabel label = new JLabel("ID :" + id );
		 label.setBounds(573, 34, 64, 14);
		 panel.add(label);
